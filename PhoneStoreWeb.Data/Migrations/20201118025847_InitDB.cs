    ...
    public partial class InitDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsDeliveries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasQuickCharge = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsReceivedId = table.Column<int>(type: "int", nullable: false),
                    ProductsDeliveryId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductItems_ProductsDeliveries_ProductsDeliveryId",
                        column: x => x.ProductsDeliveryId,
                        principalTable: "ProductsDeliveries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductItems_ProductsReceiveds_ProductsReceivedId",
                        column: x => x.ProductsReceivedId,
                        principalTable: "ProductsReceiveds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, null, new DateTime(2020, 11, 18, 9, 58, 47, 366, DateTimeKind.Local).AddTicks(2970), 0m, new Guid("69bd714f-9576-45ba-b5b7-f00649be00de") }
                });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Created_At", "Description", "ImagePath", "IsShowOnHome", "Name", "Status" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, null, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "17becd98-1e94-4f15-9bb0-6ebd8a187088", "Administrator role", "admin", "admin" },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dd"), "a32394a0-a4f5-46f7-9a8c-309e720602d4", "Client role", "client", "client" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, null, null, "991d78b2-588d-4c43-968d-5f03c4adabea", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "hieuvo044@gmail.com", true, null, null, false, null, "hieuvo044@gmail.com", "admin", "AQAAAAEAACcQAAAAELZbuLPoP5yxgYU3SFa3+0v4T8Aal9LjiBFcypk18/uK5zXPay6Q9jS6QGs1u6qLew==", null, false, new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "", false, "admin" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "BatteryCapacity", "CategoryId", "Created_At", "Description", "HasQuickCharge", "Name", "OS", "OriginalPrice", "Price", "Profitpercentage", "RAM", "Stock", "Storage" },
                values: new object[] { 1, 0, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, null, null, 17000m, 20000m, 0f, 0, 0, 0 });
            ...
            migrationBuilder.InsertData(
                table: "ProductImages",
                columns: new[] { "Id", "Caption", "FileSize", "ImagePath", "IsDefault", "ProductId" },
                values: new object[] { 2, "!23", 0L, "http://product.hstatic.net/1000026716/product/81ax00mcvn_bd76b8bf0aed4307bc9714e4dc5830f0_large.jpg", false, 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_ProductsDeliveryId",
                table: "ProductItems",
                column: "ProductsDeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_ProductsReceivedId",
                table: "ProductItems",
